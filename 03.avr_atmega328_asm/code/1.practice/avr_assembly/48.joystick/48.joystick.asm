...
; 2nd "Official" Iteration: 0616mfgh thu 18jul2024.
...
bit9:                      ; bit9 = 512
  ldi r26, 2               ; units for bit9
  push r26                 ; The stack is a LIFO data structure. Hence the sequence of pushing.
  ldi r26, 1               ; tens for bit9
  push r26
  ldi r26, 5               ; hundreds for bit9
  push r26
  mov r26, r24             ; Val from joystick
  ldi r27, 0x04            ; Bitmask for ADC-bit9 (ADC-bit9 is in ADCH-bit3).
  call updateCounter
...
; Write "updateCounter" subroutine for repeated code and consequently restructure code.
updateCounter:
  and r26, r27
  cp r26, r27
  brne nextBit
...
bit0:                      ; bit0 = 1
  ...
  ;brne processCounters    ; DANGER!!! UNCOMMENT THIS LINE OF CODE WHEN YOU WHICH TO USE IT!!!!
  ; Update units counter
  ldi r26, 1
  add r25, r26
